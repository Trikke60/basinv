...
public final class ConsoleGUI {
	...
	public static void write(Object o, String text) {
		JOptionPane.showMessageDialog(null, o, text,
				JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public static boolean nog() {
		...
		return (Character.toUpperCase(ConsoleGUI.readString("Opnieuw? J/N")
                .charAt(0)) == 'J');
	}
	...
	public static int nog(String str) {
		return JOptionPane.showConfirmDialog(null, str, "Opnieuw",
