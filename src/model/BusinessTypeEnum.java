...
public enum BusinessTypeEnum {
	CUSTOMER("Customer", 0), CONTACT("Contact", 1), ADDRESS("Address", 2), PRODUCT(
			"Product", 3), PRICE("Price", 4), QUOTE("Quote", 5), QUOTE_DETAIL(
			"Quote", 6), INVOICE("Invoice", 7), INVOICE_DETAIL("Quote", 8), NUMBER(
